...
public class SDSLegacyDriver extends SCPISocketAdapter implements Oscilloscope {
	...
	public SDSLegacyDriver(ISCPISocket socket, DeviceIdentifier deviceIdentifier, SiglentOscilloscopeInfo info) throws IOException {
	...
	private static class ChannelImpl implements AnalogInput {
		...
		@Override
		public void setProbeSense(boolean enable) {
